    ...
    <div class="home">
                ...
                <div class="menu-bar con ">
                    <div class="menu-box">
                        <ul>
                            ...
                            <li><a href="#" class=>DESIGN WORK </a></li>
                            <li><a href="#" class=>ILLUST WORK</a></li>
            ...
            <div class="center ">
                <div class="center-box">
                    <div class="center-img">
                        <img src="https://github.com/yangmikang/img1/blob/master/pf/%EB%A7%88%EB%A1%B1%EB%A7%88%EB%A1%B1/text2.png?raw=true"
                            alt="">
                        <div class="down-icon"><a href="#"><i class="fas fa-arrow-down"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="middle-text">
            <div class="middle con">
                ...
                <div class="section">
                    <div class="text">
                        <div class="img"><img src="./resource/img/노트북.PNG" alt=""></div>
                        <div class="span"></div>
                    </div>
                    <div class="content-box">
                ...
                <div class="section">
                    <div class="text">
                        <div class="img"><img src="./resource/img/붓.PNG" alt=""></div>
                        <div class="span"></div>
                    </div>
                    <div class="content-box">
