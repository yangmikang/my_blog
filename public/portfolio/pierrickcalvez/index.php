...
<body>
    <div class="top-bar con-3">
        ...
        <div class="site-menu-bar ">
            <div class="menu-box flex flex-jc-end ">
                <ul class="flex ">
                    <li class="flex"><a href="#">Art</a></li>
                    <li class="flex"><a href="#">Commissions</a></li>
                    <li class="flex"><a href="#">Shop</a></li>
                    <li class="flex"><a href="#">Studio</a></li>
                    <li class="flex"><a href="#">Journal</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="img-list .con-4">
        <div class="img-box-1 flex .con-4">
            ...
            <div class="next-img">
                <div>
                    <img src="https://github.com/yangmikang/img1/blob/master/pf/%EC%99%B8%EA%B5%AD%EC%82%AC%EC%9D%B4%ED%8A%B8/5ec3bfa24d452c18ab92e726_1905%20Summer.jpg?raw=true"
                        alt="">
    ...
    <div class="copylight">
        <div class="subscript flex  flex-jc-c ">
            <div class="sc-title ">
                <span>Sigh-up to the Newsletter and Get the Latest Upsates</span>
